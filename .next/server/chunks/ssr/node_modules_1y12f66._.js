module.exports=[33039,a=>{"use strict";var b=a.i(72131),c=a.i(6118),d=a.i(55813);let e={get url(){return`file://${a.P("node_modules/jotai/esm/react.mjs")}`}},f=(0,b.createContext)(void 0);function g(a){let d=(0,b.useContext)(f);return(null==a?void 0:a.store)||d||(0,c.getDefaultStore)()}let h=a=>"function"==typeof(null==a?void 0:a.then),i=a=>{a.status||(a.status="pending",a.then(b=>{a.status="fulfilled",a.value=b},b=>{a.status="rejected",a.reason=b}))},j=b.default.use||(a=>{if("pending"===a.status)throw a;if("fulfilled"===a.status)return a.value;if("rejected"===a.status)throw a.reason;throw i(a),a}),k=new WeakMap,l=(a,b,c)=>{let e=(0,d.INTERNAL_getBuildingBlocksRev3)(a),f=e[26],g=k.get(b);return g||(g=new Promise((d,i)=>{let j=b,l=a=>b=>{j===a&&d(b)},m=a=>b=>{j===a&&i(b)},n=()=>{try{let b=c();h(b)?(k.set(b,g),j=b,b.then(l(b),m(b)),f(e,a,b,n)):d(b)}catch(a){i(a)}};b.then(l(b),m(b)),f(e,a,b,n)}),k.set(b,g)),g};function m(a,c){let{delay:d,unstable_promiseStatus:e=!b.default.use}=c||{},f=g(c),[[k,m,n],o]=(0,b.useReducer)(b=>{let c=f.get(a);return Object.is(b[0],c)&&b[1]===f&&b[2]===a?b:[c,f,a]},void 0,()=>[f.get(a),f,a]),p=k;if((m!==f||n!==a)&&(o(),p=f.get(a)),(0,b.useEffect)(()=>{let b=f.sub(a,()=>{if(e)try{let b=f.get(a);h(b)&&i(l(f,b,()=>f.get(a)))}catch(a){}if("number"==typeof d){console.warn(`[DEPRECATED] delay option is deprecated and will be removed in v3.
...
//# sourceMappingURL=node_modules_1y12f66._.js.map