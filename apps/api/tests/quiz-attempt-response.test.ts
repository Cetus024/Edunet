...
describe('quiz attempt response', () => {
  ...
  it('derives nextReviewAt from the attempt timestamp and resulting score', () => {
    const response = buildQuizAttemptResponse({
      id: 'attempt-2',
      ...
      totalQuestions: 5,
      percentCorrect: 100,
      resultingMemoryScore: 95,
      submittedAt: new Date('2026-07-31T18:00:00.000Z'),
      idempotentReplay: false,
      answers: [],
    });

    expect(response.nextReviewAt.toISOString()).toBe('2026-08-08T01:00:00.000Z');
  });
});
