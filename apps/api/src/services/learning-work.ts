...
import { discussionParticipants, discussionRooms } from '../../../../packages/database/schema/discussion.js';
import { learningWork } from '../../../../packages/database/schema/learning-work.js';
import { squadQuizRoomParticipants, squadQuizRooms } from '../../../../packages/database/schema/squad-quiz.js';
import { studySquadMembers } from '../../../../packages/database/schema/study-squads.js';
import type { WorkInput } from '../../../../apps/web/lib/learning-work.js';
