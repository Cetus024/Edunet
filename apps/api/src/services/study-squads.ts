...
import { schools, subjects, topics } from '../../../../packages/database/schema/catalog.js';
import { discussionRooms, discussionUtterances } from '../../../../packages/database/schema/discussion.js';
import { learningWork } from '../../../../packages/database/schema/learning-work.js';
import { profiles, quizAttempts, userTopicModeProgress } from '../../../../packages/database/schema/learning.js';
import { notifications } from '../../../../packages/database/schema/notifications.js';
import { squadQuizRoomCompletions, squadQuizRooms } from '../../../../packages/database/schema/squad-quiz.js';
import {
  studySquadInvitations,
  studySquadMembers,
  studySquadStreakRestores,
  studySquads,
} from '../../../../packages/database/schema/study-squads.js';
