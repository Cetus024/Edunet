...
export const squadMemberTopicScores: SquadMemberTopicScore[] = [
  ...
  // English
  { memberId: 'maya', subject: 'English', topic: 'Comprehension', memoryScore: 34 },
  { memberId: 'maya', subject: 'English', topic: 'Summary Writing', memoryScore: 29 },
  { memberId: 'ben', subject: 'English', topic: 'Situational Writing', memoryScore: 31 },
  { memberId: 'ben', subject: 'English', topic: 'Continuous Writing', memoryScore: 35 },
  { memberId: 'aisha', subject: 'English', topic: 'Editing', memoryScore: 37 },
  { memberId: 'aisha', subject: 'English', topic: 'Visual Text', memoryScore: 33 },
  { memberId: 'leo', subject: 'English', topic: 'Comprehension', memoryScore: 28 },
  { memberId: 'leo', subject: 'English', topic: 'Continuous Writing', memoryScore: 36 },
  { memberId: 'nora', subject: 'English', topic: 'Editing', memoryScore: 30 },
  { memberId: 'nora', subject: 'English', topic: 'Visual Text', memoryScore: 38 },
  // History
  { memberId: 'maya', subject: 'History', topic: 'World War I', memoryScore: 24 },
  { memberId: 'maya', subject: 'History', topic: 'United Nations', memoryScore: 31 },
  { memberId: 'ben', subject: 'History', topic: 'World War II', memoryScore: 33 },
  { memberId: 'ben', subject: 'History', topic: 'Singapore History', memoryScore: 29 },
  { memberId: 'aisha', subject: 'History', topic: 'The Cold War', memoryScore: 37 },
  { memberId: 'aisha', subject: 'History', topic: 'Decolonisation', memoryScore: 33 },
  { memberId: 'leo', subject: 'History', topic: 'World War I', memoryScore: 26 },
  { memberId: 'leo', subject: 'History', topic: 'Singapore History', memoryScore: 39 },
  { memberId: 'nora', subject: 'History', topic: 'The Cold War', memoryScore: 36 },
  { memberId: 'nora', subject: 'History', topic: 'United Nations', memoryScore: 32 },
  // Geography
  { memberId: 'maya', subject: 'Geography', topic: 'Weather & Climate', memoryScore: 31 },
  { memberId: 'maya', subject: 'Geography', topic: 'Food Resources', memoryScore: 29 },
  { memberId: 'ben', subject: 'Geography', topic: 'Plate Tectonics', memoryScore: 34 },
  { memberId: 'ben', subject: 'Geography', topic: 'Coasts', memoryScore: 38 },
  { memberId: 'aisha', subject: 'Geography', topic: 'Rivers', memoryScore: 38 },
  { memberId: 'aisha', subject: 'Geography', topic: 'Tourism', memoryScore: 32 },
  { memberId: 'leo', subject: 'Geography', topic: 'Coasts', memoryScore: 32 },
  { memberId: 'leo', subject: 'Geography', topic: 'Weather & Climate', memoryScore: 35 },
  { memberId: 'nora', subject: 'Geography', topic: 'Plate Tectonics', memoryScore: 29 },
  { memberId: 'nora', subject: 'Geography', topic: 'Rivers', memoryScore: 34 },
  // A-Math
  { memberId: 'maya', subject: 'A-Math', topic: 'Quadratics', memoryScore: 24 },
  { memberId: 'maya', subject: 'A-Math', topic: 'Integration', memoryScore: 31 },
  { memberId: 'ben', subject: 'A-Math', topic: 'Polynomials', memoryScore: 33 },
  { memberId: 'ben', subject: 'A-Math', topic: 'Coordinate Geometry', memoryScore: 29 },
  { memberId: 'aisha', subject: 'A-Math', topic: 'Trigonometry', memoryScore: 37 },
  { memberId: 'aisha', subject: 'A-Math', topic: 'Differentiation', memoryScore: 33 },
  { memberId: 'leo', subject: 'A-Math', topic: 'Quadratics', memoryScore: 26 },
  { memberId: 'leo', subject: 'A-Math', topic: 'Coordinate Geometry', memoryScore: 39 },
  { memberId: 'nora', subject: 'A-Math', topic: 'Trigonometry', memoryScore: 36 },
  { memberId: 'nora', subject: 'A-Math', topic: 'Polynomials', memoryScore: 32 },
  // E-Math
  { memberId: 'maya', subject: 'E-Math', topic: 'Numbers', memoryScore: 31 },
  { memberId: 'maya', subject: 'E-Math', topic: 'Probability', memoryScore: 34 },
  { memberId: 'ben', subject: 'E-Math', topic: 'Algebra', memoryScore: 34 },
  { memberId: 'ben', subject: 'E-Math', topic: 'Mensuration', memoryScore: 38 },
  { memberId: 'aisha', subject: 'E-Math', topic: 'Statistics', memoryScore: 38 },
  { memberId: 'aisha', subject: 'E-Math', topic: 'Geometry', memoryScore: 32 },
  { memberId: 'leo', subject: 'E-Math', topic: 'Geometry', memoryScore: 32 },
  { memberId: 'leo', subject: 'E-Math', topic: 'Algebra', memoryScore: 35 },
  { memberId: 'nora', subject: 'E-Math', topic: 'Statistics', memoryScore: 29 },
  { memberId: 'nora', subject: 'E-Math', topic: 'Numbers', memoryScore: 34 },
];
